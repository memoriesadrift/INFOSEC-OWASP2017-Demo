...
import { secureGetUserInfo } from "../../web3/users";
import SecureMoneyExchange from "../../web3/artifacts/SecureMoneyExchange.json";
const ethUtils = require('web3-utils');

class SecureAccountForm extends React.Component {
    constructor(props) {
        super(props);
        this.state = {value: ''};
    ...
    async handleSubmit(event) {
        ...
        const result = await secureGetUserInfo(parseInt(this.state.value)) 
